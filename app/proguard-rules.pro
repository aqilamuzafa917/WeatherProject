...
-keepclassmembers class com.mobdev.domain.models.* {
    public <init>();
}
...
-keep class com.mobdev.weatherproject.domain.models.** { *; }

-keep class com.mobdev.weatherproject.domain.models.common.** { *; }
